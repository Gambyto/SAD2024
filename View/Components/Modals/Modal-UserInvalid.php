...
<div class="modal fade" id="Modal" tabindex="-1" aria-labelledby="empleadoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="empleadoModalLabel">Usuarios inhabilitados</h5>
...
function cambiarPagina(pagina) {
    $.ajax({
        url: 'Components/Tables/Tablas-UserInvalid.php',
        type: 'GET',
...
<script>
    function ReValidate(cedula)
    {
        if(confirm("Este Usuario volvera a estar habilitado ¿Desea continuar?"))
            {
                $.ajax({
                    url: '../PHP/CTR/Return_User_CTR.php',
                    type: 'POST',
                    data: {id: cedula},
                    success: function(response){
                        alert(response);
