<?php
$dato = $Nomina->View_Promedio_Prestamos();
...
// Variables
$semana = $dato[0]['semana'] + 1; // Número de la semana
$mes = $dato[0]['mes']; // Mes
$año = $dato[0]['año']; // Año

$mes_promedio = number_format($dato[0]['promedio_mensual'],2); // Mes
$semana_promedio = number_format($dato[0]['promedio_semana'],2); // Semana
