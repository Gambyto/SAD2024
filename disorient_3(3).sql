...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-03-2025 a las 17:07:02
...
(1, 17, 0, 20, 'Efectivo', '', '2025-02-07', 1),
(2, 18, 10, 40, 'Pago movil', '0000', '2025-02-08', 1),
(3, 11, 0, 10, 'Sueldo', 'No aplica', '0000-00-00', 1),
(4, 11, 0, 10, 'Sueldo', 'No aplica', '0000-00-00', 1),
(5, 11, 0, 10, 'Sueldo', 'No aplica', '2025-02-08', 1),
(6, 11, 0, 1, 'Sueldo', 'No aplica', '2025-02-08', 1),
(7, 11, 0, 1, 'Sueldo', 'No aplica', '2025-02-08', 1),
(8, 11, 0, 1, 'Sueldo', 'No aplica', '2025-02-08', 1),
...
(13, 46, 180, 20, 'Efectivo', 'No aplica', '2025-03-11', NULL);
...
INSERT INTO `empleados` (`cedula`, `nombre`, `apellido`, `direccion`, `correo`, `sexo`, `edad`, `tlf`, `second_tlf`, `departamento`, `cargo`, `f_ingreso`, `sueldo`, `afeccion`, `discapacidad`, `estado`) VALUES
(20, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(30, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(40, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(50, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(70, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(80, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(9978769, 'henrye', 'garcia', 'la villa', 'a@a.com', 'H', '1984-01-04', '0424000256', '', 's', 's', '1970-01-01', 200, 'No aplica', 'Ninguna', 1),
(11111111, 'rafael', 'marin', 'vivo en mi casa', 'jo@pm.@.com', 'H', '2025-01-27', '0424 - 0000011', '0458 - 9202020', 'Almacén', 'Almacenista', '2025-01-27', 100, 'No aplica', 'Ninguna', 0),
(11380865, 'milagros', 'arcia', 'urb.llanada,sector 01,vereda 01, numeo06', NULL, 'M', '1975-05-16', '04168947406', NULL, NULL, 'obrera', '2023-11-08', 100, 'No aplica', 'Ninguna', 1),
(12345678, 'Raul', 'Ascencio', 'Mi casa', 'a@a.com', 'H', '1999-09-03', '0424 - 1234564', '', 'Operador', 'Vendedor', '2025-03-03', 200, 'Amputación', 'Física', 1),
(16997905, 'Jose', 'Ramos', 'Urb. san jose casa b18', 'RAMOSJOSEDANIEL01@GMAIL.COM', 'H', '1985-08-10', '0412 - 9713957', '', 'Administración', 'Sub gerente', '2017-01-20', 280, 'No aplica', 'Ninguna', 1),
(22222222, 'aa', 'aa', 'a', 'a@a.com', 'H', '2005-03-10', '1111 - 1111111', '', 'Administración', 'Sub gerente', '2025-02-02', 2000, 'No aplica', 'Ninguna', 0),
(23321541, 'a', 'a', 'a', 'a@a.com', 'H', '1998-01-23', '2013 - 0220230', '', 's', 's', '1970-01-01', 20, 'No aplica', 'Ninguna', 1),
(23646851, 'prueba', 'prueba', 'a', 'a', 'H', '2009-08-27', '1234 - 5678912', '1234 - 5678912', '...', '...', '2025-01-07', 22.22, 'No aplica', 'Ninguna', 1),
(28725234, 'angel', 'rojas', 'calle sucre', NULL, 'H', '1989-09-23', '0424895463', NULL, NULL, 'Vendedor', '1980-10-16', 70, 'No aplica', 'Ninguna', 1),
(28725237, 'Gabi', 'Rojas', 'Calle sucre', 'anel7810@gmail.com', 'H', '2003-03-11', '0424 - 895463', '', 'Gerencia', 'Gerente', '2025-03-08', 130, 'No aplica', 'Ninguna', 1),
(30505643, 'dora', 'marcano', 'urb virgen del valle', 'a@a.com', 'M', '1999-05-20', '04123928296', '', 'Operador', 'Vendedor', '2023-11-02', 100, 'No aplica', 'Ninguna', 1),
(31425756, 'Gabi', 'Arias', 'urb pantanillo', NULL, 'M', '1992-07-16', '04123333332', NULL, NULL, 'gerente', '2023-11-17', 300, 'No aplica', 'Ninguna', 1);
...
(4, 2, 65.59, 28725234, 136, '2024-11-28'),
...
(37, 'prueba', NULL, 33.33, 400, 400, 12, 28725234, 166, '2025-02-08', '2025-05-03', 0),
(38, 'adelanto', NULL, 50, 200, 200, 4, 9978769, 177, '2025-03-02', '2025-03-30', 0),
(39, 'null', NULL, 50, 200, 0, 4, 12345678, 181, '2025-03-10', '2025-04-07', 0),
(40, 'null', NULL, 100, 400, 400, 4, 28725234, NULL, '2025-03-10', '2025-04-07', 0),
...
(44, 'null', NULL, 37.5, 150, 150, 4, 28725234, 182, '2025-03-10', '2025-04-07', 0),
(45, 'null', NULL, 125, 500, 500, 4, 28725234, 182, '2025-03-10', '2025-04-07', 0),
(46, 'null', NULL, 16.67, 200, 180, 12, 12345678, 182, '2025-03-11', '2025-06-03', 1),
(47, 'null', NULL, 10.42, 125, 125, 12, 28725234, 182, '2025-03-11', '2025-06-03', 1),
...
(146, 55.3, '2025-01-22'),
(147, 55.3, '2025-01-22'),
(148, 56.65, '2025-01-25'),
(149, 56.65, '2025-01-26'),
(150, 56.65, '2025-01-27'),
(151, 56.65, '2025-01-27'),
(152, 56.86, '2025-01-28'),
(153, 58.44, '2025-01-31'),
(154, 58.44, '2025-02-01'),
(155, 58.44, '2025-02-01'),
(156, 58.44, '2025-02-01'),
(161, 58.44, '2025-02-03'),
(162, 58.54, '2025-02-04'),
(163, 59.46, '2025-02-05'),
(164, 59.46, '2025-02-06'),
(165, 60.14, '2025-02-07'),
(166, 60.52, '2025-02-08'),
(167, 60.52, '2025-02-09'),
(168, 60.52, '2025-02-10'),
(169, 60.54, '2025-02-11'),
(170, 61.35, '2025-02-13'),
(171, 61.82, '2025-02-14'),
(172, 63.41, '2025-02-21'),
(173, 63.49, '2025-02-25'),
(174, 64.25, '2025-02-27'),
(175, 64.48, '2025-02-28'),
(176, 64.48, '2025-03-01'),
(177, 64.48, '2025-03-02'),
(178, 64.48, '2025-03-03'),
(179, 65.27, '2025-03-07'),
(180, 65.27, '2025-03-08'),
(181, 65.27, '2025-03-09'),
(182, 65.27, '2025-03-10'),
(183, 65.42, '2025-03-11'),
(184, 65.63, '2025-03-12');
...
(3, 'prueba1', '1234', 9978769, 'Administrador', 1),
(4, 'dora', '1234', 30505643, 'Administrador', 1),
(5, 'prueba2', '1234', 31425756, 'Gerencia', 1),
(6, 'prueba3', '1234', 23321541, 'Trabajador', 1),
(7, 'prueba4', '12345', 12345678, 'Gerencia', 1);
...
--
ALTER TABLE `cuentas_por_pagar2`
  MODIFY `id_cp` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `fideicomiso`
--
ALTER TABLE `fideicomiso`
  MODIFY `id_fideicomiso` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `islr`
--
ALTER TABLE `islr`
  MODIFY `id_islr` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `nomina`
--
ALTER TABLE `nomina`
  MODIFY `id_nomina` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;

--
-- AUTO_INCREMENT de la tabla `prestamos`
--
ALTER TABLE `prestamos`
  MODIFY `id_prestamos` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT de la tabla `solicitudes`
--
ALTER TABLE `solicitudes`
  MODIFY `id_solicitud` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `tasa_dolar`
--
ALTER TABLE `tasa_dolar`
  MODIFY `id_tasa` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=185;
...
--
ALTER TABLE `vacaciones_y_utilidades`
  MODIFY `vacaciones_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
