...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-03-2025 a las 20:19:29
...
INSERT INTO `cuentas_por_pagar2` (`id_cp`, `id_prestamo`, `deuda`, `aporte`, `tpago`, `refe`, `fecha`) VALUES
(1, 17, 0, 20, 'Efectivo', '', '2025-02-07'),
(2, 18, 10, 40, 'Pago movil', '0000', '2025-02-08'),
(3, 11, 0, 10, 'Sueldo', 'No aplica', '0000-00-00'),
(4, 11, 0, 10, 'Sueldo', 'No aplica', '0000-00-00'),
(5, 11, 0, 10, 'Sueldo', 'No aplica', '2025-02-08'),
(6, 11, 0, 1, 'Sueldo', 'No aplica', '2025-02-08'),
(7, 11, 0, 1, 'Sueldo', 'No aplica', '2025-02-08'),
(8, 11, 0, 1, 'Sueldo', 'No aplica', '2025-02-08'),
(9, 11, 0, 17, 'Sueldo', 'No aplica', '2025-02-08'),
(10, 22, 90, 10, 'Sueldo', 'No aplica', '2025-02-08'),
(11, 22, 60, 30, 'Efectivo', 'No aplica', '2025-02-08');
...
(30, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(40, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(50, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(70, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(80, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0),
(9978769, 'henrye', 'garcia', 'la villa', 'a@a.com', 'H', '1984-01-04', '0424000256', '', 's', 's', '1970-01-01', 200, 1),
(11111111, 'rafael', 'marin', 'vivo en mi casa', 'jo@pm.@.com', 'H', '2025-01-27', '0424 - 0000011', '0458 - 9202020', 'Almacén', 'Almacenista', '2025-01-27', 100, 0),
(11380865, 'milagros', 'arcia', 'urb.llanada,sector 01,vereda 01, numeo06', NULL, 'M', '1975-05-16', '04168947406', NULL, NULL, 'obrera', '2023-11-08', 100, 1),
(22222222, 'aa', 'aa', 'a', 'a@a.com', 'H', '2005-03-10', '1111 - 1111111', '', 'Administración', 'Sub gerente', '2025-02-02', 2000, 0),
(23321541, 'a', 'a', 'a', 'a@a.com', 'H', '1998-01-23', '2013 - 0220230', '', 's', 's', '1970-01-01', 20, 1),
(23646851, 'prueba', 'prueba', 'a', 'a', 'H', '2009-08-27', '1234 - 5678912', '1234 - 5678912', '...', '...', '2025-01-07', 22.22, 1),
(28725234, 'angel', 'rojas', 'calle sucre', NULL, 'H', '1989-09-23', '0424895463', NULL, NULL, 'Vendedor', '1980-10-16', 70, 1),
(30505643, 'dora', 'marcano', 'urb virgen del valle', 'a@a.com', 'M', '1999-05-20', '04123928296', '', 'Operador', 'Vendedor', '2023-11-02', 100, 1),
(31425756, 'Gabi', 'Arias', 'urb pantanillo', NULL, 'M', '1992-07-16', '04123333332', NULL, NULL, 'gerente', '2023-11-17', 300, 1);
...
--
ALTER TABLE `cuentas_por_pagar2`
  MODIFY `id_cp` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `nomina`
  MODIFY `id_nomina` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT de la tabla `prestamos`
--
ALTER TABLE `prestamos`
  MODIFY `id_prestamos` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `tasa_dolar`
  MODIFY `id_tasa` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=177;
